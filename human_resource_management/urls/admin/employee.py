...
from human_resource_management.views.admin.employee import *

urlpatterns = [
        # Employee Division
        path('employee_division/',
        EmployeeDivisionViewSet.as_view({'post': 'create', 'get': 'list'},  name='employee_division')),
        path('employee_division/<slug>/',
        EmployeeDivisionViewSet.as_view({'patch': 'update', 'get': 'retrieve'},  name='employee_division')),

        # Employee Department

        path('employee_department/',
        EmployeeDepartmentViewSet.as_view({'post': 'create', 'get': 'list'},  name='employee_department')),
        path('employee_department/<slug>/',
                EmployeeDepartmentViewSet.as_view({'patch': 'update', 'get': 'retrieve'},  name='employee_department')),
        ...
        path('employee_information_download/',
                EmployeeDownloadViewSet.as_view({'get': 'list'},  name='employee_information_download')), 
