...
from human_resource_management.models.employee import Department,  Grading, Ranking, Designation, EmployeeType, EmployeeGuardianInformation, EmployeeAddressInformation, ExamType, EmployeeEducationInformation, BankInformation, EmployeeInformation, EmployeeDivision,Department, EmployeeInformationLog
...
class EmployeeInformationAdmin(admin.ModelAdmin):
    ...
    list_filter = ['user__user_informations__user_type__name','work_station__name']
