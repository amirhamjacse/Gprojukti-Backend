...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        file_path = 'settings_management/management/file/delete_from_pekua.xlsx'  # Define your file path here
        ...
        try:
            ...
            not_updated_file_path = 'product_stocks_not_updated_15.xlsx'
            ...
            for row in sheet.iter_rows(values_only=True):
                ...
                if barcode:
                    ...
                    product_stock = ProductStock.objects.filter(barcode=str(barcode)).first()
                    print(product_stock, 'product code')

                    if product_stock:
                        # Check and update the stock_location add your desire stock location id here
                        # if product_stock.stock_location_id == 31:
                        # if product_stock.stock_location_id == 40:
